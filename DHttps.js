/*
YANG ASLI PUYA REYHAN 6610

SORI YE GW MINIGIKASI

BASE BY t.me/Gray_Hat_anon
...
try {
var proxies = fs.readFileSync("./lib/tmp/proxy.txt", 'utf-8').toString().replace(/\r/g, '').split('\n');
} catch(error){
...
const sigalgs = [
 ...
 try {
var UAs = fs.readFileSync('./lib/tmp/ua.txt', 'utf-8').replace(/\r/g, '').split('\n');
 } catch(error){
